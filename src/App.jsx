...
function App() {
  ...
  const lighting = useControls('Ajustes Visuales', {
    ...
    skyColorTop: { value: savedConfig.skyColorTop ?? '#fcfcfc', label: 'Cielo (Arriba)' },
    skyColorBottom: { value: savedConfig.skyColorBottom ?? '#ffdddd', label: 'Cielo (Horizonte)' },
    ...
    sunColor: { value: savedConfig.sunColor ?? '#d5bcaa', label: 'Color Sol' },
    ...
    waterColor: { value: savedConfig.waterColor ?? '#004488', label: 'Color Agua' },
